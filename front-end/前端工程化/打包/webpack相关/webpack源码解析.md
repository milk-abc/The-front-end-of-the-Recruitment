...
![image-20240420001841809](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420001841809.png)

![image-20240420105353094](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420105353094.png)

![image-20240420001759781](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420001759781.png)

![image-20240420010409059](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420010409059.png)

![image-20240420093921906](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420093921906.png)

![image-20240420094121833](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420094121833.png)

![image-20240420094055691](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420094055691.png)

![image-20240420123747036](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420123747036.png)

![image-20240420123558826](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420123558826.png)

![image-20240420130533172](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420130533172.png)

![image-20240420141049736](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420141049736.png)

![image-20240420141303879](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420141303879.png)

![image-20240420141445767](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420141445767.png)

![image-20240420141939580](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420141939580.png)

![image-20240420142220184](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420142220184.png)

![image-20240420143104617](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420143104617.png)
...
然后继续回到cli.js执行compiler.run函数，run函数传入一个回调，在run函数中调用beforeRun->run钩子->compiler.compile，在compile编译函数中首先会初始化编译环境的参数【normalModuleFactory，contextModuleFactory，compilationDependencies】，再执行beforeCompile->compile->初始化newCompilation，此时会执行thisCompilation和compilation钩子里的所有插件用于编译前的准备。然后执行make钩子的回调，首先创建依赖，通过addEntry添加入口，调用_addModuleChain函数，调用moduleFactory.create函数，调用hooks.beforeResolve tap回调，执行NormalModuleFactory中的factory回调，在该回调中首先执行resolver钩子的回调，通过查找依赖项创建模块链，依赖添加完后会执行buildmodule，这里会将模块转为ast语法树。

![image-20240420205650777](C:\Users\liqian\AppData\Roaming\Typora\typora-user-images\image-20240420205650777.png)

从addEntry开始，后续的调用顺序：
compiliation.addEntry -> compiliation.addModuleChain -> compiliation.handleModuleCreation -> compiliation.addModule -> compiliation.buildModule -> compiliation._buildModule -> module.build
最终会走到NormalModule对象(./lib/NormalModule.js)中，执行build方法 -> doBuild。

由上面代码可以看出，doBuild实际上就是选择合适的loader去加载resource，转换为js模块，再返回转换后的文件以便后续继续处理（webpack只对js模块做了处理，处理其他文件如css、json、scss、jpg就需要其他loader的帮助）。

在module.build回调中，执行了这样一句代码
`const result = this.parser.parse(source)`
this.parser就是JavascriptParser的实例对象
lib/JavascriptParser.js

可知loader是在buildmodule中进行调用转换的，plugin是在对应的生命周期进行调用转换的。

# webpack 源码阅读

基于 webpack5.24

[![img](https://github.com/gweid/webpack-source-code/raw/main/imgs/img7.jpg)](https://github.com/gweid/webpack-source-code/blob/main/imgs/img7.jpg)
...
[<img src="https://github.com/gweid/webpack-source-code/raw/main/imgs/img1.png" alt="img" style="zoom:100%;" />](https://github.com/gweid/webpack-source-code/blob/main/imgs/img1.png)
...
[![img](https://github.com/gweid/webpack-source-code/raw/main/imgs/img2.png)](https://github.com/gweid/webpack-source-code/blob/main/imgs/img2.png)
...
[![img](https://github.com/gweid/webpack-source-code/raw/main/imgs/img3.png)](https://github.com/gweid/webpack-source-code/blob/main/imgs/img3.png)
...
[![img](https://github.com/gweid/webpack-source-code/raw/main/imgs/img4.png)](https://github.com/gweid/webpack-source-code/blob/main/imgs/img4.png)
...
[![dep](https://github.com/lihongxun945/diving-into-webpack/raw/master/images/dep.png)](https://github.com/lihongxun945/diving-into-webpack/blob/master/images/dep.png)
...
[![dep](https://github.com/lihongxun945/diving-into-webpack/raw/master/images/dep2.png)](https://github.com/lihongxun945/diving-into-webpack/blob/master/images/dep2.png)
...
[![img](https://github.com/gweid/webpack-source-code/raw/main/imgs/img5.png)](https://github.com/gweid/webpack-source-code/blob/main/imgs/img5.png)

[![img](https://github.com/gweid/webpack-source-code/raw/main/imgs/img6.jpg)](https://github.com/gweid/webpack-source-code/blob/main/imgs/img6.jpg)

## 总结

1. 调用webpack函数，接收config配置信息，实例化compiler，初始化内置插件（调用所有内置插件的.apply）

2. 调用compiler.run进入编译阶段

3. 1. 每一次新的编译都会实例化一个`compilation`对象，记录本次编译的基本信息；

   2. 进入`make`阶段，即触发`compilation.hooks.make`钩子，从`entry`为入口

   3. 1. 执行对应的loader对模块进行预处理转为标准的js模块
      2. 调用三方插件`acorn`对标准JS模块进行分析，递归每个依赖项，生成语法树

   4. 最后调用`compilation.seal` render 模块，整合各个依赖项，最后输出一个或多个chunk
